...
export HOST_IP=`/sbin/ifconfig -a | grep inet | grep -v 127.0.0.1 | grep -v 172. | grep -v 10.0 | grep -v inet6 | awk '{print $2}' | tr -d "addr:"`
...
echo "Environment start successfully!"